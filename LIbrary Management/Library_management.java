...
public class Library_management extends JFrame implements ActionListener 
    ...
    public Library_management() 
        ...
        label3 = new JLabel("Book Title");
        label4 = new JLabel("Author");
        label5 = new JLabel("Publisher");
        label6 = new JLabel("Year of Publication");
...
{
            String[] columns = {"Name","Book ID", "Book Title", "Author", "Publisher", "Year of Publication", "ISBN", "Number of Copies"};
